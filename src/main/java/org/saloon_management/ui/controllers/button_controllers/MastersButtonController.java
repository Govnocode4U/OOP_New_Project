...
@Component
@FxmlView("/tabs/buttons/masters-button.fxml")
public class MastersButtonController {
    @Autowired
    ...
    @FXML
    public void onMastersButtonClicked() throws IOException {
        FXMLLoader loaderTable = new FXMLLoader(getClass().getResource("/tabs/vboxs/masters-vbox-table.fxml"));
        ...
        MastersVboxController tableController = loaderTable.getController();
